...
public class TokenApiDelegateImpl implements TokenApiDelegate {
  ...
  @Override
  public ResponseEntity<TokenResponse> tokenLogin(Map<String, String> tokenLoginRequest) throws InvalidRequestException, InvalidClientException, InvalidScopeException, SigningOperationException, SigningVerificationException, KeyRetrievalException, UnsupportedGrantTypeException {
